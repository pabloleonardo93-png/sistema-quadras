...
router.get("/minhas", validarEmailVerificado, controller.listarMinhas);
router.get("/minhas/:id", validarEmailVerificado, controller.buscarMinhaPorId);
router.patch("/minhas/:id/dados", validarEmailVerificado, controller.atualizarMeusDados);
router.post("/minhas/:id/cancelar", validarEmailVerificado, controller.cancelarMinha);
