...
import VerificacaoEmail from "./VerificacaoEmail.js";
...
VerificacaoEmail.hasMany(Reserva, { foreignKey: "emailVerificacaoId", as: "reservas" });
Reserva.belongsTo(VerificacaoEmail, { foreignKey: "emailVerificacaoId", as: "emailVerificacao" });
...
export { Admin, Arquivo, Cliente, Comunicado, Horario, LogSistema, Modalidade, Quadra, QuadraModalidade, Reserva, VerificacaoEmail };
