...
import { QUADRA_STATUS, QUADRA_STATUS_LISTA } from "../shared/constants/statusAdministrativos.js";
...
const Quadra = sequelize.define("Quadra", {
  ...
  status: { type: DataTypes.ENUM(...QUADRA_STATUS_LISTA), allowNull: false, defaultValue: QUADRA_STATUS.ATIVA },
